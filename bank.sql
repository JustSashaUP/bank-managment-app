...
--
-- Host: 127.0.0.1
-- Generation Time: May 30, 2024 at 01:22 PM
...
CREATE DEFINER=`root`@`localhost` FUNCTION `is_deposit_exist` (`id` INT) RETURNS TINYINT(1)  BEGIN
	...
	SELECT COUNT(*) INTO counter
	FROM deposit
	WHERE account_id = id AND deposit_status = 'open';
	IF counter > 0 THEN
	SET is_exist = TRUE;
	END IF;
	RETURN is_exist;
...
(1, 1, 'UAH', '2701299863153979', 12050.00, 'online', '2024-05-26 18:44:58'),
(2, 2, 'UAH', '4340148903807752', 655.75, 'online', '2024-05-26 18:44:58'),
...
(6, 1, 'USD', '2036040094702985', 0.00, 'online', '2024-05-30 12:37:47'),
(7, 1, 'EUR', '5129676863028405', 0.00, 'online', '2024-05-30 12:43:31');
...
(7, 1, 12000.00, '2024-05-30 12:38:52', '2024-08-30 00:00:00', 'open', 2.50, 1000000.00),
(8, 6, 1000.00, '2024-05-30 12:43:40', '2025-05-30 00:00:00', 'open', 2.50, 1000000.00);
...
(4, 1, 1000.00, '2024-05-30', '2024-06-13', 1.50, 'open'),
(5, 6, 12000.50, '2024-05-30', '2024-06-14', 1.50, 'open');
...
(16, 1, 2, 20.00, '2024-05-30 12:38:27', 'successfully', 'funds transfer'),
(17, NULL, 6, 500.00, '2024-05-30 12:44:29', 'successfully', 'account top-up'),
(18, 6, 2, 500.00, '2024-05-30 12:44:53', 'successfully', 'funds transfer');
